...
#Run docker registry
echo -e "13.Run docker registry,use \"\033[32mdocker-registry\033[0m\" command,you can add command in /etc/rc.local"
echo -e "13.安装完毕，可以执行\033[32mdocker-registry\033[0m命令启动，可以将命令加入/etc/rc.local开机自动执行"
